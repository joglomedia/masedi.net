...
<p>
<strong>Alamat Email</strong> : <input name="email" value="" type="text" size="14" />
<br />atau<br />
<strong>Nomor Telepon</strong> : + <input name="phone" value="" type="text" size="14" maxlength="14" />
<br />Format nomor telepon (masukkan kode negara), ex: 628xxxxxx
</p>
<p><input type="submit" name="submit" value="Undang saya untuk Berburu Genk Ovi!" /></p>
</form>
