...
<?php if ('open' == $post->comment_status) : ?>
  ...
  <div class="respond-left">
	<div class="input"><label for="author"><?php _e('Name', 'default'); ?></label><br />
	<input type="text" name="author" id="author" value="<?php echo $comment_author; ?>" size="22" tabindex="1" <?php if ($req) echo "aria-required='true'"; ?> />
    <br /><?php if ($req) echo "(required)"; ?></div>  
	<div class="input"><label for="email"><?php _e('Mail (will not be published)', 'default'); ?></label><br />
	<input type="text" name="email" id="email" value="<?php echo $comment_author_email; ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
	<br /><?php if ($req) echo "(required)"; ?></div>   
	<div class="input"><label for="url"><?php _e('Website', 'default'); ?></label><br />
