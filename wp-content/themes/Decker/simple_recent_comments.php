...
/* Changelog
* Tue Jul 22 2008 - v.0.1.3
- Plugin -> data display update by Bogdan L.
...
//	$output .= "\n<div id=\"recent-comments\">";
	foreach ($comments as $comment) {
		$output .= "\n\t<p><a href=\"" . get_permalink($comment->ID) . "#comment-" . $comment->comment_ID  . "\" title=\"on " . $comment->post_title . "\">" . $comment->comment_author . "</a>:<span class=\"text\"> " . strip_tags($comment->com_excerpt) . "...</span></p>";
	}
//	$output .= "\n</div>";
	$output .= $post_HTML;
