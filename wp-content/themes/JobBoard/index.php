...
if($_REQUEST['page']=='registration' && $_REQUEST['frm']=='jobpost')
{
	...
	exit;	
}elseif($_REQUEST['page']=='postajob' || $_REQUEST['page']=='editjob')
{
...
elseif($_REQUEST['page'] == 'csvdl' || $_REQUEST['page'] == 'csvdl_job' || $_REQUEST['page'] == 'csvdl_resume')
{
...
elseif($_REQUEST['page']=='resume')
{
	...
	exit;
}elseif($_REQUEST['page']=='apply'){
		if($_REQUEST['action']=='add')	{
			global $posts;
			apply_for_job($_REQUEST['pid'],$post);
		}else{
			remove_from_job($_REQUEST['pid']);
		}
		exit;
}
