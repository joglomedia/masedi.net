...
if($_POST && !$userInfo)
{
	if (  $_SESSION['resume_info']['user_email'] == '' )
	{
		...
		echo '<h6><b><a href="'.get_option('siteurl').'/?page=postaresume&backandedit=1">Return to '.__(SUBMIT_PROPERTY_TEXT).'</a></b></h6>';
		exit;
	}
	...
	$user_login = $_SESSION['resume_info']['user_fname'];
	...
	$userName = $_SESSION['resume_info']['user_fname'];
