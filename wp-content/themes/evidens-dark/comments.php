...
<?php foreach ($comments as $comment) : ?>
 ...
 <p class="avt"><img src="<?php gravatar("R", 60); ?>" alt="Avatar" /></p>
...
<?php else : ?>
<p><input id="comment-name" value="<?php echo $comment_author; ?>" name="author"  type="text" /> <label for="comment-name">Your Name <strong class="required"><?php if ($req) echo "(required)"; ?></strong></label></p>
<p><input id="comment-email" name="email" value="<?php echo $comment_author_email; ?>" type="text" /> <label for="comment-name">Your Email <strong class="required"><?php if ($req) echo "(required)"; ?></strong></label></p>
<p><input id="comment-url" name="url" value="<?php echo $comment_author_url; ?>" type="text" /> <label for="comment-name">Your URL</label></p>
<?php endif; ?>								
