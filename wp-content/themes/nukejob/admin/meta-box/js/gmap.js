...
jQuery( document ).ready( function ()
{
   ...
   function updatePositionInput( latLng )
   {
	  ...
	  // addition
	  jQuery( '#rwmb-map-latitude' ).val( latLng.lat() );
	  jQuery( '#rwmb-map-longitude' ).val( latLng.lng() );
   }
   ...
   function autoCompleteAddress(){
      ...
      jQuery( '#' + addressField).autocomplete({
		...
		// additional for displaying latitude & longitude coordinate
		jQuery("#rmwb-map-latitude").val(ui.item.latitude);
		jQuery("#rmwb-map-longitude").val(ui.item.longitude);
