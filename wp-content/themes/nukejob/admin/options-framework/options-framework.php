...
/**
 * Some little modification adapted to work with WPNuke framework
 */
function optionsframework_init() {

	// Include the required files
	wpnuke_require(OPTIONS_FRAMEWORK_DIRECTORY . '/options-interface.php');
	wpnuke_require(OPTIONS_FRAMEWORK_DIRECTORY . '/options-media-uploader.php');
	
	// Loads the options array from the theme
	if ( $optionsfile = apply_filters( 'options_framework_location', 'options.php' ) ) {
		wpnuke_require($optionsfile);
	}
	else if ( file_exists( WPNUKE_ADMIN_DIR . '/options-settings.php' ) ) {
	...
	else { 	// If the developer hasn't explicitly set an option id, we'll use a default
...
/**
 * Little modification for theme url path error, adapted to work with WPNuke Framework
 */
