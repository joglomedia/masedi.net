...
function wpnuke_pagenavi($before = '', $after = '') {
...
function wpnuke_pagenavi_dropdown() { 
	wpnuke_pagenavi(); 
}
...
function pagenavi_init() {
	...
	$pagenavi_options['pages_text'] = __('Page %CURRENT_PAGE% of %TOTAL_PAGES%','wpnuke');
	$pagenavi_options['current_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['page_text'] = '%PAGE_NUMBER%';
	$pagenavi_options['first_text'] = __('&laquo; First','wpnuke');
	$pagenavi_options['last_text'] = __('Last &raquo;','wpnuke');
	$pagenavi_options['next_text'] = __('&raquo;','wpnuke');
	$pagenavi_options['prev_text'] = __('&laquo;','wpnuke');
	$pagenavi_options['dotright_text'] = __('...','wpnuke');
	$pagenavi_options['dotleft_text'] = __('...','wpnuke');
