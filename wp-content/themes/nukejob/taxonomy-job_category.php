			...
			<div id="content" role="main">
				...
				<div class="post">
					<article class="post-content">
						<?php
						// grab the taxonomy job category info
						$taxonomy = get_query_var('taxonomy');
						$term = get_term_by('slug', get_query_var('term'), $taxonomy);				
						?>
						<?php if(function_exists('wpnuke_breadcrumb')) wpnuke_breadcrumb(); ?><!--breadcrumb-->
						<header>
							<h1 class="page-title"><?php printf(__('Jobs in the "%s" Category', 'wpnuke'), $term->name ); ?></h1>								
						...
						<div class="entry clearfix">
							...
							?>
								...
								<?php else : ?>
								<p class="error"><?php _e('Sorry, no expired jobs matched your criteria.', 'wpnuke');?></p>
								<?php endif; ?>
								<?php if(function_exists('wpnuke_pagenavi')) : ?>
								<div class="pagination">
									<?php wpnuke_pagenavi(); ?>
